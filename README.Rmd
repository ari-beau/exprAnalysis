...
```
`expressionAnalysis` contains 5 functions to analyze gene expression data. The
...
control samples. The *exprPlot* produces boxplots to visualize differential gene 
expression.
